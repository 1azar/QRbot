...
func main() {
	...
	fmt.Println(bf)
	////_, err := os.Open("C:/Usersasdf")
	//////err := errors.New("BLUAAA")
	////fmt.Println("some error: ", "huyabuya")
	////l := infrastructure.NewLogger()
	////l.Info("salam", "aleykum")
	////l.Error("london ", "good ", ": ", err)
	//
